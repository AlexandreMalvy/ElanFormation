...
final class Version20210525115518 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE formation_modul (formation_id INT NOT NULL, modul_id INT NOT NULL, INDEX IDX_EBDCFEFD5200282E (formation_id), INDEX IDX_EBDCFEFD19952065 (modul_id), PRIMARY KEY(formation_id, modul_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE modul (id INT AUTO_INCREMENT NOT NULL, `option` VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE formation_modul ADD CONSTRAINT FK_EBDCFEFD19952065 FOREIGN KEY (modul_id) REFERENCES modul (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formation_modul DROP FOREIGN KEY FK_EBDCFEFD5200282E');
        $this->addSql('ALTER TABLE session DROP FOREIGN KEY FK_D044D5D45200282E');
        $this->addSql('ALTER TABLE formation_modul DROP FOREIGN KEY FK_EBDCFEFD19952065');
